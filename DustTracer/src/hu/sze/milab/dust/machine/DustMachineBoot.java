...
public class DustMachineBoot implements DustMachineConsts {
	...
	static void boot(DustMachine machine, String[] args) throws Exception {
		...
		DustUtilsAttCache.set(MachineAtts.TransientAtt, true, MIND_ATT_KNOWLEDGE_HANDLE, MIND_ATT_UNIT_HANDLES, MIND_ATT_UNIT_CONTENT, DUST_ATT_NATIVELOGIC_INSTANCE);
