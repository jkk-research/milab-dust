...
public interface DustMetaConsts extends DustConsts {
	...
	public static MindHandle DUST_ASP_MODULE = Dust.recall("2:9");
	public static MindHandle DUST_ATT_MODULE_UNITS = Dust.recall("2:10");
	public static MindHandle DUST_ATT_MODULE_NATIVELOGICS = Dust.recall("2:11");
	public static MindHandle DUST_ATT_MODULE_LIBRARIES = Dust.recall("2:12");

	public static MindHandle DUST_ASP_THREAD = Dust.recall("2:13");
