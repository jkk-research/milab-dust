...
public interface DustMetaConsts extends DustConsts {
	...
	public static MindHandle MISC_ASP_ALIAS = Dust.recall("3:9");
	public static MindHandle MISC_ASP_GEN = Dust.recall("3:10");
	public static MindHandle MISC_ATT_GEN_COUNT = Dust.recall("3:11");

	public static MindHandle MISC_TAG_GEN_EMPTY = Dust.recall("3:12");

	public static MindHandle MISC_TAG_GEN_ACTIVE = Dust.recall("3:13");

	public static MindHandle MISC_ASP_VARIANT = Dust.recall("3:14");
	public static MindHandle MISC_ATT_VARIANT_VALUE = Dust.recall("3:15");
	...
	public static MindHandle EVENT_TAG_TYPE_INFO = Dust.recall("5:5");
	public static MindHandle EVENT_TAG_TYPE_TRACE = Dust.recall("5:6");
	public static MindHandle EVENT_TAG_TYPE_BREAKPOINT = Dust.recall("5:7");
